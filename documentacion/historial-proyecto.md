...
today's Humble, with improvements in performance and stability — the
[README](../README.md) shows the current version.
...
| *Navigating an already mapped environment* | *Real-time mapping with the LiDAR* |
...
| *RViz visualisation and odometry* | *CAD design in Autodesk Inventor* |

| **Mercury Robotics Challenge** | **Teleoperation** |
|:-----------------------------:|:--------------------------:|
...
| *Axioma One at Mercury 2019* | *Teleoperation over Raspberry Pi + Flask* |
